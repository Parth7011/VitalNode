...
// SocialIcons component to display a list of social media links with SVG icons
const SocialIcons = () => {
    const socialLinks = [
        {
            name: "Facebook",
    ...
    return (
        <div className="flex justify-center items-center gap-6 my-12 w-full max-w-7xl mx-auto px-4">
            {socialLinks.map((social) => (
                <a
                    ...
                    className="w-[60px] h-[60px] bg-[#34C38F] hover:bg-[#48d0a0] rounded-[20px] 
                               shadow-sm shadow-black/5 hover:shadow-lg hover:shadow-[#34C38F]/40 
