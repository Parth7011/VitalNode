...
// DashboardSidebar component providing navigation links for the patient dashboard
const DashboardSidebar = () => {
    ...
    // Define navigation menu items with their respective icons and paths
    const patientMenuItems = [
        ...
        {
            name: 'Prescriptions', path: '/prescription', icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'My Treatments', path: '/my-treatments', icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Profile', path: getDashboardPath(), icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
